...
--ce_weight=1.0 --mse_weight=8.0 --cycle_weight=8.0
...
--name=MMIN_MOSI --suffix=block_{n_blocks}_run_{gpu_ids}_{run_idx} --has_test
--pretrained_path='checkpoints/MOSI_pretrained_MMIN_AVL_run$pretrained_idx'
--cvNo=$i"
