...
--ce_weight=1 --mse_weight=2.0 --consistent_weight=100
...
--name=CIFMMIN_IEMOCAP --suffix=block_{n_blocks}_{run_idx} --has_test
--pretrained_path='checkpoints/CAP_pretrained_CIFMMIN_AVL_run$pretrained_idx'
--cvNo=$i"
