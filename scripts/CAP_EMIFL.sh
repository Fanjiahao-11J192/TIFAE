...
cmd="python train_miss.py --dataset_mode=multimodal_miss --model=EMIFL
...
--pretrained_path='checkpoints/CAP_pretrained_EFIML_AVL_run$pretrained_idx'
...
--name=EMIFL_IEMOCAP --suffix=block_{n_blocks}_run{run_idx} --has_test
--cvNo=$i"
