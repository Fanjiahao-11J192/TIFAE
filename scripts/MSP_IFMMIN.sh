...
--pretrained_path=checkpoints/MSP_pretrained_IFMMIN_AVL_run$pretrained_idx
--ce_weight=1.0 --mse_weight=2.0 --cycle_weight=0.5 --invariant_weight=100
...
--name=IFMMIN_MSP_f1 --suffix=block_{n_blocks}_run{run_idx} --has_test
--cvNo=$i"
