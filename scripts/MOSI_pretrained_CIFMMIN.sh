...
cmd="python train_baseline.py --dataset_mode=multimodal --model=pretrained_CIFMMIN
...
--name=MOSI_pretrained_CIFMMIN --suffix={modality}_run{run_idx} --has_test
--cvNo=$i"
