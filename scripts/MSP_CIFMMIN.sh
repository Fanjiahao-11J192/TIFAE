...
cmd="python train_miss.py --dataset_mode=multimodal_miss --model=CIFMMIN
...
--pretrained_path=checkpoints/MSP_pretrained_CIFMMIN_AVL_run$pretrained_idx
--ce_weight=1.0 --mse_weight=2.0 --cycle_weight=0.5 --consistent_weight=100
...
--name=CIFMMIN_MSP_f1 --suffix=block_{n_blocks}_run{run_idx} --has_test
--cvNo=$i"
