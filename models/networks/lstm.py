...
class LSTMEncoder(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, embd_method='last'):
        ...
        self.rnn = nn.LSTM(self.input_size, self.hidden_size, batch_first=True,bidirectional=False)
        assert embd_method in ['maxpool', 'attention', 'last', 'avgpool']
    ...
    def embd_avgpool(self, r_out, h_n):
        in_feat = r_out.transpose(1, 2)
