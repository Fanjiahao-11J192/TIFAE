...
from models.networks.Transformer.position_embedding import SinusoidalPositionalEmbedding
from models.networks.Transformer.multihead_attention import MultiheadAttention
import math
