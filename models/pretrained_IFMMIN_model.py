...
from models.utils.functions import CMD
...
class UttSharedModel(BaseModel):
    ...
    def forward(self):
        ...
        self.feat_transformer_fusion = self.feat
        self.feat_shared_transformer_fusion = self.feat_shared
